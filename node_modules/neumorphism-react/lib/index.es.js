...
const NeuDiv = ({
  ...
  column,
  ...props
}) => React.createElement(DivWrapper, _extends({
...
const NeuButton = ({
  ...
  distance,
  ...props
}) => React.createElement(ButtonWrapper, _extends({
...
const NeuClock = ({
  ...
  return (// eslint-disable-next-line react/jsx-props-no-spreading
    React.createElement(Clock, _extends({}, props, {
      size: size,
      color: color,
      distance: distance,
      "data-testid": "neuclock-clock"
    }), React.createElement(InnerClock, {
      size: innerClockWidth,
      donut: donut,
      color: color,
      distance: distance,
      "data-testid": "neuclock-innerclock"
    }, tirets.map(tiret => React.createElement(TiretPos, {
      key: tiret.hour,
      x: getX(tiret.teta),
      y: getY(tiret.teta),
      teta: tiret.teta
    }, React.createElement(Tiret, null))), React.createElement(CenterPos, null, React.createElement(Center, null, React.createElement(Seconds, {
      ref: secondsRef
...
const NeuSlider = ({
  ...
  return (// eslint-disable-next-line react/jsx-props-no-spreading
    React.createElement(NeuDiv, _extends({
      distance: distance,
      height: "45px",
      color: color,
      radius: 10
...
React.createElement(NeuDiv, _extends({
  ...
  radius: 10,
  distance: distance
}, props), React.createElement(ProgressWrapper, {
  "data-testid": "neuprogress-wrapper"
}, React.createElement(NeuDiv, {
  distance: 3,
  height: "15px",
  color: color,
  radius: 4,
...
const NeuRadio = ({
  ...
  return (// eslint-disable-next-line react/jsx-props-no-spreading
    ...
    }, props), data && (data === null || data === void 0 ? void 0 : data.length) !== 0 && data.map((d, index) => React.createElement(RadioBlockWrapper, {
      key: d + index
...
const NeuToggle = ({
  ...
  return React.createElement(ToggleWrapper, _extends({
  ...
  }, props), React.createElement(Toggle, {
...
export { NeuButton, NeuClock, NeuDiv, NeuProgress, NeuRadio, NeuSlider, NeuTextInput, NeuToggle };
